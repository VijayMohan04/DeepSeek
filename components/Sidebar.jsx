  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Image
              ...
              alt="menu icon"
              className="md:hidden w-5 h-auto"
            />
            <Image
      ...
      <div>
        ...
        >
          <Image
            className={expand ? "w-5 h-auto" : "w-6 mx-auto h-auto"}
          ...
          >
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              <Image className="w-44 h-auto" src={assets.qrcode} alt="qrcode" />
          ...
          {expand && (
            <>
              {" "}
              <span>Get App</span> <Image src={assets.new_icon} alt="" className="w-4 h-auto" />{" "}
            </>
          )}
        </div>
